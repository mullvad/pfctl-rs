...
fn contains_subset(haystack: &Vec<String>, subset: &Vec<String>) -> bool {
    subset.iter().all(|state| haystack.contains(state))
}

fn not_contains_subset(haystack: &Vec<String>, subset: &Vec<String>) -> bool {
    subset.iter().all(|state| !haystack.contains(state))
}
