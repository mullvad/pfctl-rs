...
mod filter_rule_tests {
    ...
    fn state_policy_correct_default() {
        let testee = FilterRuleBuilder::default().action(RuleAction::Pass).build().unwrap();
        assert_eq!(StatePolicy::None, testee.validate_state_policy().unwrap());
    }

    #[test]
    fn state_policy_no_state() {
        let mut testee = FilterRuleBuilder::default();
        testee.action(RuleAction::Pass);
        assert_eq!(
            StatePolicy::None,
    ...
    #[test]
    fn state_policy_incompatible_modulate_udp() {
        let mut testee = FilterRuleBuilder::default();
        testee.action(RuleAction::Pass);
        assert!(
            testee
    ...
    #[test]
    fn state_policy_incompatible_synproxy_udp() {
        let mut testee = FilterRuleBuilder::default();
        testee.action(RuleAction::Pass);
        assert!(
            testee
